// Base de datos de productos con precios reales actualizados
const productData = {
    'ganocafe-3-en-1': {
    ...
    'shoko-rico': {
        ...
        isGanodermaBased: true,
        wellnessTags: ['relajacion', 'digestivo']
    },
    'ganocereal-spirulina': {
        ...
        isGanodermaBased: true,
        wellnessTags: ['digestivo', 'energia', 'defensas']
    },
    'oleaf-rooibos': {
    ...
    'capsulas-excellium': {
        ...
        isGanodermaBased: true,
        wellnessTags: ['concentracion', 'energia']
    },
    'capsulas-cordy-gold': {
